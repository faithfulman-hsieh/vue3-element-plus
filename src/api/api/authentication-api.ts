...
export const AuthenticationAPIFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        login(requestParameters: AuthenticationAPILoginRequest, options?: RawAxiosRequestConfig): AxiosPromise<string> {
...
export class AuthenticationAPI extends BaseAPI {
    ...
    public login(requestParameters: AuthenticationAPILoginRequest, options?: RawAxiosRequestConfig) {
        return AuthenticationAPIFp(this.configuration).login(requestParameters.authRequest, options).then((request) => request(this.axios, this.basePath));
    }
}
